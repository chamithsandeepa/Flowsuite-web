  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-1/3 right-0 w-60 sm:w-80 md:w-96 h-60 sm:h-80 md:h-96 bg-red-50 rounded-full blur-3xl opacity-40"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, -30, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/4 left-0 w-56 sm:w-72 md:w-80 h-56 sm:h-72 md:h-80 bg-gray-100 rounded-full blur-3xl opacity-50"
          animate={{
            scale: [1, 1.15, 1],
            x: [0, 20, 0],
          }}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="w-full lg:flex-1 max-w-2xl order-1 lg:order-1">
            <div className="relative flex justify-center items-center">
              ...
              <div className="absolute -top-3 -left-3 w-16 h-16 sm:w-20 sm:h-20 bg-red-200/30 rounded-full blur-xl" />
              <div className="absolute -bottom-3 -right-3 w-20 h-20 sm:w-24 sm:h-24 bg-gray-200/40 rounded-full blur-xl" />
            </div>
          </div>
