...
interface DesignManagementSectionProps {}

const DesignManagementSection = ({}: DesignManagementSectionProps) => {
  const features = [
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-16">
          ...
          >
            ...
            >
              {/* Glow */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-br from-gray-200/50 to-stone-100/30 blur-2xl sm:blur-3xl rounded-lg transform scale-105"
              ...
              >
                <img
                  ...
                  alt="FlowSuite Design Management Dashboard"
              ...
              {/* Accents */}
              <motion.div
                className="absolute -top-4 sm:-top-6 -left-4 sm:-left-6 w-16 h-16 sm:w-24 sm:h-24 bg-stone-200/30 rounded-full blur-lg sm:blur-xl"
          ...
          >
            ...
            <div className="space-y-4 max-w-lg mx-auto lg:mx-0">
              ...
              >
                ...
                visibility and control over your apparel orders from start to
                finish.
              </p>
            </div>
...
export default DesignManagementSection;
