  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-1/3 left-0 w-72 sm:w-80 md:w-96 h-72 sm:h-80 md:h-96 bg-red-50 rounded-full blur-3xl opacity-40"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 30, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-0 w-64 sm:w-72 md:w-80 h-64 sm:h-72 md:h-80 bg-gray-100 rounded-full blur-3xl opacity-50"
          animate={{
            scale: [1, 1.15, 1],
            x: [0, -20, 0],
          }}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-16 min-h-[calc(100vh-8rem)]">
          ...
          <div className="lg:flex-1 w-full max-w-xl sm:max-w-2xl order-2 lg:order-1">
            <div className="relative">
              ...
              {/* Damage Flow Dashboard Image */}
              <img
                src="/images/damage.png"
                alt="FlowSuite Damage Flow Control System"
