...
interface PrintingControlSectionProps {}

const PrintingControlSection = ({}: PrintingControlSectionProps) => {
  const features = [
    "View all assigned orders with key details at a glance.",
    "Update status from 'Printing' to 'Printed' in one click.",
    "Log damages with type, quantity, and notes.",
    "Track every order's printing progress in real time",
    "Keep the workflow smooth from print to press.",
  ];
  ...
  return (
    <div className="relative bg-gradient-to-br from-stone-100 via-gray-100 to-slate-100 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-1/4 right-6 sm:right-10 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-gray-200 rounded-full blur-3xl opacity-50"
          animate={{ scale: [1, 1.15, 1], x: [0, -30, 0] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-1/3 left-6 sm:left-10 w-56 h-56 sm:w-72 sm:h-72 md:w-80 md:h-80 bg-slate-200 rounded-full blur-3xl opacity-40"
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 sm:gap-12 lg:gap-16">
          ...
          >
            ...
            >
              {/* Glow */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-br from-gray-200/50 to-slate-100/30 blur-2xl sm:blur-3xl rounded-lg transform scale-105"
              ...
              >
                <img
                  ...
                  alt="FlowSuite Simplified Printing Control"
              ...
              {/* Accents */}
              <motion.div
                className="absolute -top-4 sm:-top-6 -left-4 sm:-left-6 w-16 h-16 sm:w-24 sm:h-24 bg-slate-200/30 rounded-full blur-lg sm:blur-xl"
          ...
          >
            ...
            <div className="space-y-4 max-w-lg mx-auto lg:mx-0">
              ...
              >
                Printers can easily see their orders, update printing status,
                and record damages all in one dashboard.
              </p>
            </div>
...
export default PrintingControlSection;
